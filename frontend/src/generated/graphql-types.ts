...
export type CreateNewPostMutation = {
  ...
  createNewPost: {
    ...
    titre: string;
    photo: string;
    residents?: Array<{ __typename?: "Resident"; id: number }> | null;
  };
};
...
export type GetAllResidentsQuery = {
  __typename?: "Query";
  getAllResidents: Array<{ __typename?: "Resident"; id: number; name: string }>;
};
...
export type GetAllUsersQuery = {
  ...
  getAllUsers: Array<{
    ...
    userName: string;
    role: string;
    resident: { __typename?: "Resident"; name: string };
  }>;
};
 ...
 * });
 */
export function useGetAllResidentsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetAllResidentsQuery,
    GetAllResidentsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetAllResidentsQuery, GetAllResidentsQueryVariables>(
    GetAllResidentsDocument,
    options
  );
}
export function useGetAllResidentsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetAllResidentsQuery,
    GetAllResidentsQueryVariables
  >
  ...
  return Apollo.useLazyQuery<
    GetAllResidentsQuery,
    GetAllResidentsQueryVariables
  >(GetAllResidentsDocument, options);
}
export function useGetAllResidentsSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetAllResidentsQuery,
...
export type GetAllResidentsQueryHookResult = ReturnType<
  typeof useGetAllResidentsQuery
>;
export type GetAllResidentsLazyQueryHookResult = ReturnType<
  typeof useGetAllResidentsLazyQuery
>;
export type GetAllResidentsSuspenseQueryHookResult = ReturnType<
  typeof useGetAllResidentsSuspenseQuery
>;
export type GetAllResidentsQueryResult = Apollo.QueryResult<
  GetAllResidentsQuery,
  GetAllResidentsQueryVariables
>;
