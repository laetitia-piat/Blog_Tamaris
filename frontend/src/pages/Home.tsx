...
const HomePage = () => {
  ...
  if (data && userInfos.data?.getUserInfo.isLoggedIn) {
    ...
    return (
      ...
      >
        <h1 className="text-4xl lg:text-6xl text-[#3c5c39] font-bold pb-20 lg:pt-40">
          BLOG DES TAMARIS
        </h1>
        <form
          className="flex flex-col bg-[#f7f0e1] rounded-lg w-[75%] md:w-1/3 lg:m-auto lg:mt-30 pt-10"
